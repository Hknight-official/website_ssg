...
function RightNavBar({ isRight, handleClickRight }) {
  ...
  return (
    <>
      <div
        className={
          "right-navbar-main col-lg-3 " + (isRight ? "show-right-mobile" : "")
        }
      >
        <div className="p-1 fw-bold text-center">GPT Assistant</div>
        <button
          onClick={handleClickRight}
          className="show-button-mobile show-right-button btn btn-sm btn-default border-1 border-white text-white z-2"
          style={{
            position: "absolute",
            right: "10px",
            top: "10px",
