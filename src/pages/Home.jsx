            ...
            ((!userData['name']) ? (<div>Loading please wait...</div>) : (
                <DataUserContext.Provider value={userData}>
                    <div className="home-page row">
                        <LeftNavBar listSupporter={listSupporter} handleClickLeft={() => {setIsLeft(!isLeft)}} isLeft={isLeft} />
                        <Chat listSupporter={listSupporter} handleSetListSupporter={setListSupporter} handleClickLeft={() => {setIsLeft(!isLeft)}} handleClickRight={() => {setIsRight(!isRight)}} roomId={userData.id} />
